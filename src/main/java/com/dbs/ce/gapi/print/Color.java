package com.dbs.ce.gapi.print;

/**
 * @author Lei
 * @version 1.0
 * @Description print log with log using ANSI escape sequences
 */
public class Color {
    ...
    public static void main(String[] args) {
        ...
        for (int i : new int[]{0, 1, 4, 7}) {
            for (int j = 30; j <= 37; j++) {
                for (int k = 40; k <= 47; k++) {
                    String format = "\033[" + i + ";" + j + ";" + k + "m";
                    System.out.print(format + "~Text~" + ConsoleColors.RESET);
                }
                System.out.println();
            }
